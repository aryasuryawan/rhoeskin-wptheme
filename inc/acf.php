...
acf_add_local_field_group([
    ...
    'fields' => [
        ...
        [
            ...
            'type'  => 'text',
            'default_value' => 'Mulai Perjalanan Kecantikan Anda',
        ],
        [
            'key'   => 'field_alya_tech_cta_title',
            'label' => 'CTA Title',
            'name'  => 'alya_cta_title',
            'type'  => 'text',
            'default_value' => 'Rasakan Teknologi Medis Terbaik',
        ],
        [
            'key'   => 'field_alya_tech_cta_desc',
            'label' => 'CTA Description',
            'name'  => 'alya_cta_desc',
            'type'  => 'textarea',
            'rows'  => 2,
            'default_value' => 'Konsultasikan kebutuhan Anda dengan dokter kami dan temukan treatment berbasis teknologi yang paling tepat.',
        ],
        [
...
/* ================================================================
 * FIELD GROUP: Technology page only (OLD - commented out, replaced by custom meta box)
 * ================================================================ */
/*
acf_add_local_field_group([
        ...
        [
            ...
            'sub_fields'   => [
                [
                    ...
                    'label' => 'Category ID (for anchor link)',
                    'name'  => 'category_id',
                    'type'  => 'text',
                    'placeholder' => 'e.g., laser-devices',
                    'required' => 1,
                ],
                [
                    'key'   => 'field_alya_tech_cat_number',
                ...
                [
                    'key'   => 'field_alya_tech_cat_eyebrow',
                    'label' => 'Category Eyebrow',
                    'name'  => 'category_eyebrow',
                    'type'  => 'text',
                    'placeholder' => 'e.g., ADVANCED LASER',
                ],
                [
                    'key'   => 'field_alya_tech_cat_label',
                    'label' => 'Category Label (for navigation)',
                    'name'  => 'category_label',
                    'type'  => 'text',
                    'required' => 1,
                    'placeholder' => 'e.g., Laser Devices',
                ...
                [
                    'key'   => 'field_alya_tech_cat_title',
                    'label' => 'Category Title',
                    'name'  => 'category_title',
                    'type'  => 'text',
                    'required' => 1,
                    'placeholder' => 'e.g., Advanced Laser Technology',
                ],
                [
                    'key'   => 'field_alya_tech_cat_badge',
                    'label' => 'Category Badge (optional)',
                    'name'  => 'category_badge',
                    'type'  => 'text',
                    'placeholder' => 'e.g., FDA Approved',
                ],
                [
                    'key'           => 'field_alya_tech_cat_bg_alt',
                ...
                [
                    ...
                    'sub_fields'   => [
                        [
                            ...
                            'name'  => 'brand_tag',
                            'type'  => 'text',
                            'placeholder' => 'e.g., Lutronic™',
                        ],
                        [
                            'key'   => 'field_alya_device_title',
                            'label' => 'Device Name',
                            'name'  => 'device_title',
                            'type'  => 'text',
                            'required' => 1,
                            'placeholder' => 'e.g., Nd:YAG Laser',
                        ],
                        [
                            'key'   => 'field_alya_device_desc',
                        ...
                        [
                            'key'          => 'field_alya_device_features',
                            'label'        => 'Features',
                            'name'         => 'features',
                            'type'         => 'repeater',
                            'layout'       => 'table',
                        ...
                        [
                            'key'   => 'field_alya_device_origin_badge',
                            'label' => 'Origin Badge',
                            'name'  => 'origin_badge',
                            'type'  => 'text',
    ...
    'label_placement' => 'top',
    'active'          => true,
    'hide_on_screen'  => ['the_content'], // Hide default editor
]);
